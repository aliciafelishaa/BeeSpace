...
export default function CreateRoomPage() {
    ...
    const handleNext = () => {
        ...
        if (formData.place && !formData.locationDetail)
            errors.locationDetail = formData.place === "Online"
                ...
                <View className="flex-row items-center justify-between mb-8 mx-12">
                    {[1, 2, 3].map((num, index) => (
                        <React.Fragment key={num} >
                            ...
                            {index < 2 && (
                                <View
                                    className={`flex-1 h-[2px] ${step > num ? "bg-[#FFD661]" : "bg-[#FFF6D5]"
                                        }`}
                                />
                            )}
                        </React.Fragment>
                        ...
                        <View>
                            ...
                            <DropdownInput
                                ...
                                options={[
                                    ...
                                    { label: "Transportation Sharing", value: "Transportation Sharing" },
                                    { label: "Academic & Study", value: "Academic & Study" },
                                    { label: "Events & Activities", value: "Events & Activities" },
                                    { label: "Food & Hangout", value: "Food & Hangout" },
                                    { label: "Community & Hobby", value: "Community & Hobby" },
                                    { label: "Health & Wellness", value: "Health & Wellness" },
                                    { label: "Competition & Challenge", value: "Competition & Challenge" },
                                ...
                                {formData.place !== "" && (
                                    <FormInput
                                        ...
                                        onChangeText={(v) => {
                                            ...
                                            setFormErrors(prev => ({ ...prev, locationDetail: "" }))
                                        }}
                                        placeholder={
                    ...
                    <View className="w-full flex-row mt-6 gap-4">
                        {step > 1 ? (
                            <>
                                ...
                                >
                                    <Text className="text-[#FCBC03] font-medium text-lg">Back</Text>
                                </TouchableOpacity>
                            ...
                            <TouchableOpacity
                                ...
                                className="flex-1 bg-[#FCBC03] py-3 rounded-xl items-center justify-center"
                            >
                                <Text className="text-white font-bold text-lg" style={{ fontWeight: 'bold' }}>Next</Text>
                            </TouchableOpacity>
                        )}
                    </View>
                </View>
