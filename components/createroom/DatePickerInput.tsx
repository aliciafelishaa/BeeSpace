    ...
    return (
        <View className="mb-4">
            ...
            {Platform.OS === "web" ? (
                ...
                <>
                    <TouchableOpacity onPress={handleOpen} className={`flex-row justify-between items-center border rounded-xl px-4 py-3 bg-white ${internalError ? "border-[#EF4444]" : "border-gray-300"}`}>
                        <Text className={`text-base ${value ? "text-gray-900" : "text-gray-400"}`}>{value || "Select date"}</Text>
                        <Calendar size={20} />
                    </TouchableOpacity>
