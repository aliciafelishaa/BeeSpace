...
export const ChatWindow: React.FC<ChatWindowProps> = ({ chat, onBack, isGroupChat = false }) => {
      ...
      >
        ...
        {chatUser?.avatar ? (
          ...
          <View
            ...
            style={{ backgroundColor: isGroupChat ? COLORS.primary2nd : COLORS.neutral300 }}
          >
            <Text
            ...
            return (
              ...
              >
                ...
                <View
                  ...
                  style={{ 
                    backgroundColor: isOwnMessage ? COLORS.primary2nd : COLORS.white 
                  }}
                >
                  <Text
                  ...
                  <View className="flex-row items-center justify-end gap-1">
                    <Text
                      className="text-[10px]"
                      style={{ 
                        color: isOwnMessage ? COLORS.primary4th : COLORS.neutral500 
                      }}
                    >
